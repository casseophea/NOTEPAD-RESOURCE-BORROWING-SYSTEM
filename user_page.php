<?php
// user_page.php - User Home Dashboard for Barangay Tiniguiban Resource Borrowing System
    ...
    <main>
        ...
        <div class="top-row">
            ...
            <div class="action-btns">
                <button class="btn-action" onclick="window.location.href='user_inventory.php'">View Inventory</button>
                <button class="btn-action" onclick="window.location.href='request_page.php'">Request Item</button>
                <button class="btn-action" onclick="window.location.href='my_request_page.php'">Check My Requests</button>
            </div>
                    ...
                    <?php if (!empty($activities)): ?>
                        <?php foreach ($activities as $row): ?>
                            <tr>
                                ...
                                $maskedFirst = substr($first, 0, 1) . str_repeat('*', max(strlen($first) - 1, 0));
                                $maskedLast = substr($last, 0, 1) . str_repeat('*', max(strlen($last) - 1, 0));
